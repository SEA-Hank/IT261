...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (
            ...
            $message = "";
            if ($total > 2000) {
                $message = "I'm a happy camper, because I have $ $totalFormat American Dollars and I am going shopping!!!";
            } else {
                $message = "I'm not happy because I only have $ $totalFormat American Dollars!!!";
            }
    ?>
            <div class="box">
                <?= $message ?>
